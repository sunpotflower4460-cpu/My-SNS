...
- **inbox_items** - Comments, mentions, DMs, and replies — internal notes plus, as of PR6, real Instagram webhook deliveries and YouTube pull-synced comments; `external_id` + a partial unique index dedupe the same platform event across retries/overlapping syncs
